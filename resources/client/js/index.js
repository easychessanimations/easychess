    ...
    renderAuthDiv(){
        let authDiv = div().a(
            div().bc("#777").pad(10).mar(5).a(                
                ...
                div().bc("#fff").mart(10).tac().pad(10).fs(20).html(`<a href="https://github.com/easychessanimations/botlogin/commits/master" rel="noopener noreferrer" target="_blank">User login history</a>`),
